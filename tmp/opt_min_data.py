...
time_list = ['09:31', '09:32', '09:33', '09:34', '09:35', '09:36', '09:37', '09:38', '09:39', '09:40',
...
min_path = '/media/hdd1/DAT_OPT/Min'
...
def deal_fun(date, opt_file):
    ...
    target_df = target_df.reindex(time_list)
    ...
    if os.path.exists(f'{min_path}/{opt_file}'):
        ...
        new_target_df.to_csv(f'{min_path}/{opt_file}', sep='|', index=False)
    else:
        target_df.to_csv(f'{min_path}/{opt_file}', sep='|', index=False)


date_list = sorted([x for x in os.listdir('/media/hdd1/DAT_OPT/Tick') if x >= '20200210'])
