...
def out_sample_perf_c(pnl_df_out, way=1):
    ...
    return out_condition, sharpe_out * way
...
def filter_time_para_fun(time_para_dict, pos_df_daily, adj_return, index_df, if_hedge=True, hedge_ratio=1,
    ...
    for time_key in time_para_dict.keys():
        ...
        sample_out_index_2 = (adj_return.index >= end_para_1) & (adj_return.index < end_para_2)
        sample_out_index_3 = (adj_return.index >= end_para_2) & (adj_return.index < end_para_3)
        sample_out_index_4 = (adj_return.index >= end_para_3) & (adj_return.index < end_para_4)
        # 样本内表现
        ...
        ic = bt.AZ_Normal_IC(pos_df_daily_in, adj_return_in, min_valids=None, lag=0).round(4).mean()
        ...
        if if_return_pnl:
            result_dict[time_key] = [in_condition, out_condition_1, out_condition_2, out_condition_3, out_condition_4,
                                     ...
                                     sp_out_1, sp_out_2, sp_out_3, sp_out_4, pnl_df]
        else:
            result_dict[time_key] = [in_condition, out_condition_1, out_condition_2, out_condition_3, out_condition_4,
                                     ic, sp_in_u, sp_in_m, sp_in_d, pot_in, fit_ratio, leve_ratio,
