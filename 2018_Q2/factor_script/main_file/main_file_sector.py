...
if __name__ == '__main__':
    ...
    sector_name_list = ['market_top_1000',
                        'market_top_1000_industry_10_15',
    ...
    for sector_name in sector_name_list[:1]:
        ...
        pool_num = 10
        main.test_index_3_(change_list, ratio_list, tech_list, pool_num, suffix_name='1_l')
