...
def create_all_para():
    ...
    for fun in fun_mix_2_set:
        print(fun.__name__)
        for index_choose_1, index_choose_2, index_choose_3 in file_name_comb:
            if 'mul' in fun.__name__ and fun.__name__[:3] != fun.__name__[4:7]:
                index_comb = permutations([index_choose_1, index_choose_2, index_choose_3], 3)
            else:
                index_comb = combinations([index_choose_1, index_choose_2, index_choose_3], 3)
            for index_choose_1_, index_choose_2_, index_choose_3_ in index_comb:
                for return_name in return_name_list:
                    yield fun.__name__, index_choose_1_, index_choose_2_, index_choose_3_, return_name
