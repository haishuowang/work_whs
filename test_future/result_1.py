...
def part_test(con_id, begin_time, end_time,
    ...
    try:
        ...
        part_data_df['weekday_pos'] = (part_data_df['weekday'] != 2).astype(int)
        ...
        part_data_df['position_sft'] = part_data_df['position'].shift(3) * part_data_df['trend_signal'] \
...
def main():
    fut_name = 'I'
    data_df = test_fun(fut_name, 400, 1.5)
...
if __name__ == '__main__':
    ...
    #     plt.plot(part_pnl.cumsum())
    #     savfig_send(subject=f'{x}  {bt.AZ_Sharpe_y(part_pnl)}')
    # 'I sp:1.7995 pot=14.559667866586489 CCI_window:400, CCI_limit:1.5'
