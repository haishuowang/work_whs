...
def main1():
    ...
    config7 = pd.read_pickle(f'{config_path}/CRTSECJUN03.pkl')
    factor_info7 = config7['factor_info']

    file_name_list = list(set(factor_info7[['name3']].values.ravel()))
...
def main2():
    ...
    config8 = pd.read_pickle(f'{config_path}/CRTSECJUN04.pkl')
    factor_info8 = config8['factor_info']

    file_name_list = list(set(factor_info8[['name3']].values.ravel()))
