...
def config_test():
    config_set = pd.read_pickle(f'/media/hdd1/DAT_PreCalc/PreCalc_whs/CRTSECJUN04.pkl')
    ...
    sum_pos_df.round(10).to_csv(f'/mnt/mfs/AAPOS/WHSCRTSEC02.pos', sep='|', index_label='Date')
    return sum_pos_df
