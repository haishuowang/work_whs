...
class FactorTestCRT(FactorTest):
    def __init__(self, root_path, if_save, if_new_program, begin_date, cut_date, end_date, time_para_dict,
                 sector_name, hold_time, lag, return_file, if_hedge, if_only_long, ind_file_list):
        self.ind_file_list = ind_file_list
        args = (root_path, if_save, if_new_program, begin_date, cut_date, end_date, time_para_dict,
...
def config_test():
    ...
    config_set = pd.read_pickle(f'/media/hdd1/DAT_PreCalc/PreCalc_whs/config_file/CRTSECJUN04.pkl')
    ...
    sector_name = 'market_top_2000_industry_20_25_30_35'
    hold_time = 20
    lag = 2
    return_file = ''
    ...
    sum_pos_df.round(10).fillna(0).to_csv(f'/mnt/mfs/AAPOS/WHSCRTSEC02.pos', sep='|', index_label='Date')
    return sum_pos_df
