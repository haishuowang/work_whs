...
if __name__ == '__main__':
    ...
    plot_save_fun('test_d', all_tmp_df_d, return_df, locked_df, hold_time_list, index_df, now_time)
    plot_save_fun('test_d_h', all_tmp_df_d, return_df, locked_df, hold_time_list, index_df, now_time, if_hedge=True)
    plot_save_fun('test_u', all_tmp_df_u, return_df, locked_df, hold_time_list, index_df, now_time)
    plot_save_fun('test_u_h', all_tmp_df_u, return_df, locked_df, hold_time_list, index_df, now_time, if_hedge=True)
