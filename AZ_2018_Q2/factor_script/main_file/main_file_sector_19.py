...
class FactorTestSector(mf.FactorTest):
    ...
    def part_test_index_3_(self, key, name_1, name_2, name_3, log_save_file, result_save_file, total_para_num):
        ...
        change_factor = self.load_whs_factor(name_1)
        ratio_factor = self.load_whs_factor(name_2)
    ...
    def single_test(self, fun_name, name1, name2, name3):
        ...
        change_factor = self.load_whs_factor(name1)
        ratio_factor = self.load_whs_factor(name2)
...
def main_fun(sector_name, hold_time, if_only_long, time_para_dict):
    ...
    main.test_index_3_(abnom_factor_list, abnom_factor_list, tech_list, pool_num, suffix_name=suffix_name)
