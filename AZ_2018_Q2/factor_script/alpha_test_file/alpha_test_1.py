...
from factor_script.main_file import main_file as mf
...
if __name__ == '__main__':
    ...
    pool_num = 20
    file_name = 'market_top_2000_True_20180903_1018_hold_20_aadj_r.txt'
    main.test_index_3(tech_name_list, funda_name_list, pool_num, file_name=file_name)
