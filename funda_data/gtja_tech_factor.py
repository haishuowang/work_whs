...
class TechFactor():
    ...
    ########################################################################
    def alpha_004(self):
        condition1 = (bt.AZ_Rolling(self.close, 8).std() < bt.AZ_Rolling(self.close, 2).sum() / 2)
        condition2 = (bt.AZ_Rolling(self.close, 2).sum() / 2 <
                      (bt.AZ_Rolling(self.close, 8).sum() / 8 - bt.AZ_Rolling(self.close, 8).std()))
        condition3 = (1 <= self.volume / bt.AZ_Rolling(self.volume, 20).mean())
        ...
        part0 = bt.AZ_Rolling(self.close, 8).sum() / 8
    ...
    def alpha_005(self):
        ...
        corr_ts = bt.AZ_Rolling(ts_high, 5).corr(ts_volume)
    ...
    def alpha_010(self):
        ...
        condtion = (ret < 0)
        part1 = (bt.AZ_Rolling(ret, 20).std()[condtion]).fillna(0)
    ...
    ##################################################################
    def alpha_012(self):
        vwap10 = bt.AZ_Rolling(self.avg_price, 10).sum() / 10
    ...
    def alpha_016(self):
        ...
        part = bt.AZ_Rolling(temp1, 5).corr(temp2)
    ...
    def alpha_017(self):
        temp1 = bt.AZ_Rolling(self.avg_price, 15).max()
    ...
    def alpha_021(self):
        A = bt.AZ_Rolling(self.close, 6).mean().iloc[-6:, :]
    ...
    def alpha_022(self):
        part1 = (self.close - bt.AZ_Rolling(self.close, 6).mean()) / bt.AZ_Rolling(self.close, 6).mean()
        temp = (self.close - bt.AZ_Rolling(self.close, 6).mean()) / bt.AZ_Rolling(self.close, 6).mean()
        part2 = temp.shift(3)
        result = part1 - part2
        # result = bt.AZ_Rolling(result, 1.0 / 12)
        alpha = result.iloc[-1, :]
        return alpha.dropna()
    ...
    def alpha_023(self):
        ...
        temp1 = bt.AZ_Rolling(self.close, 20).std()[condition1]
        temp1 = temp1.fillna(0)
        temp2 = bt.AZ_Rolling(self.close, 20).std()[~condition1]
        temp2 = temp2.fillna(0)
        part1 = bt.AZ_Rolling(temp1, 20).mean()
        part2 = bt.AZ_Rolling(temp2, 20).mean()
    ...
    def alpha_025(self):
        ...
        part1 = part1.iloc[-1, :]
        temp = self.volume / bt.AZ_Rolling(self.volume, 20).mena()
        temp1 = temp.iloc[-9:, :]
    ...
    ##################################################################
    def alpha_026(self):
        part1 = bt.AZ_Rolling(self.close, 7).sum() / 7 - self.close
        part1 = part1.iloc[-1, :]
        delay5 = self.close.shift(5)
        part2 = bt.AZ_Rolling(self.avg_price, 230).corr(delay5)
        part2 = part2.iloc[-1, :]
        alpha = part1 + part2
        return alpha.dropna()
    ...
    ##################################################################
    # def alpha_028(self):
    #     temp1 = self.close - bt.AZ_Rolling(self.low, 9).min()
    #     temp2 = bt.AZ_Rolling(self.high, 9).max() - bt.AZ_Rolling(self.low, 9).min()
    ...
    ##################################################################
    def alpha_031(self):
        result = (self.close - bt.AZ_Rolling(self.close, 12).mean()) * 100 / bt.AZ_Rolling(self.close, 12).mean()
        alpha = result.iloc[-1, :]
        return alpha.dropna()
    ...
    def alpha_032(self):
        ...
        # temp3 = bt.AZ_Rolling_corr(temp1, temp2, 3)
        temp3 = bt.AZ_Rolling(temp1, 3).corr(temp2)
    ...
    def alpha_033(self):
        ret = self.close.pct_change()
        temp1 = bt.AZ_Rolling(self.low, 5).min()  # TS_MIN
        part1 = temp1.shift(5) - temp1
        part1 = part1.iloc[-1, :]
        temp2 = (bt.AZ_Rolling(ret, 240).sum() - bt.AZ_Rolling(ret, 20).sum()) / 220
        part2 = temp2.rank(axis=1, pct=True)
        part2 = part2.iloc[-1, :]
    ...
    ##################################################################
    def alpha_034(self):
        result = bt.AZ_Rolling(self.close, 12).mean() / self.close
        alpha = result.iloc[-1, :]
        return alpha.dropna()
    ...
    def alpha_035(self):
        ...
        temp2 = bt.AZ_Rolling(temp2, 17).corr(self.volume)
        temp2 = temp2.iloc[-m:, :]
    ...
    def alpha_036(self):
        temp1 = self.volume.rank(axis=1, pct=True)
        temp2 = self.avg_price.rank(axis=1, pct=True)
        part1 = bt.AZ_Rolling_corr(temp1, temp2, 6)
        result = bt.AZ_Rolling_sum(part1, 2)
    ...
    def alpha_037(self):
        ret = self.close.pct_change()
        temp = bt.AZ_Rolling_sum(self.open_price, 5) * bt.AZ_Rolling_sum(ret, 5)
    ...
    ##################################################################
    def alpha_038(self):
        sum_20 = bt.AZ_Rolling_sum(self.high, 20) / 20
    ...
    def alpha_039(self):
        ...
        volume_180 = bt.AZ_Rolling_mean(self.volume, 180)
        sum_vol = bt.AZ_Rolling_sum(volume_180, 37)
        temp3 = bt.AZ_Rolling_corr(temp2, sum_vol, 14)
        temp3 = temp3.iloc[-m:, :]
    ...
    def alpha_040(self):
        ...
        vol_sum = bt.AZ_Rolling_sum(vol, 26)
        vol1 = self.volume[~condition].fillna(0)
        vol1_sum = bt.AZ_Rolling_sum(vol1, 26)
    ...
    ##################################################################
    def alpha_042(self):
        part1 = bt.AZ_Rolling_corr(self.high, self.volume, 10)
        part2 = bt.AZ_Rolling_std(self.high, 10)
    ...
    def alpha_043(self):
        ...
        result = temp1 + temp2
        result = bt.AZ_Rolling_sum(result, 6)
        alpha = result.iloc[-1, :].dropna()
        return alpha
    ...
    def alpha_044(self):
        ...
        n = 6
        m = 10
        temp1 = bt.AZ_Rolling_corr(self.low, bt.AZ_Rolling_mean(self.volume, 10), 7)
        temp1 = temp1.iloc[-n:, :]
        seq1 = [2 * i / (n * (n + 1)) for i in range(1, n + 1)]  # Decaylinear 1
        seq2 = [2 * i / (m * (m + 1)) for i in range(1, m + 1)]  # Decaylinear 2
        # weight1=np.array(seq1[::-1])
    ...
    def alpha_045(self):
        ...
        part1 = temp1.diff()
        part1 = part1.rank(axis=1, pct=True)
        temp2 = bt.AZ_Rolling_mean(self.volume, 150)
        part2 = bt.AZ_Rolling_corr(self.avg_price, temp2, 15)
        part2 = part2.rank(axis=1, pct=True)
        result = part1 * part2
        alpha = result.iloc[-1, :].dropna()
        return alpha
    ...
    ##################################################################
    def alpha_046(self):
        part1 = bt.AZ_Rolling_mean(self.close, 3)
        part2 = bt.AZ_Rolling_mean(self.close, 6)
        part3 = bt.AZ_Rolling_mean(self.close, 12)
        part4 = bt.AZ_Rolling_mean(self.close, 24)
    ...
    ##################################################################
    # def alpha_047(self):
    #     part1 = bt.AZ_Rolling_max(self.high, 6) - self.close
    #     part2 = bt.AZ_Rolling_max(self.high, 6) - bt.AZ_Rolling_min(self.low, 6)
    ...
    def alpha_048(self):
        ...
        result = -summ * bt.AZ_Rolling_sum(self.volume, 5) / bt.AZ_Rolling_sum(self.volume, 20)
        alpha = result.iloc[-1, :].dropna()
        return alpha
    ...
    def alpha_056(self):
        ...
        temp1 = bt.AZ_Rolling_sum(temp1, 19)
        temp2 = bt.AZ_Rolling_sum(bt.AZ_Rolling_mean(self.volume, 40), 19)
    ...
    ##################################################################
    # def alpha_057(self):
    #     part1 = self.close - bt.AZ_Rolling_min(self.low, 9)
    #     part2 = bt.AZ_Rolling_max(self.high, 9) - bt.AZ_Rolling_min(self.low, 9)
    ...
    def alpha_061(self):
        ...
        temp2 = self.low
        temp2 = bt.AZ_Rolling_corr(temp2, bt.AZ_Rolling_mean(self.volume, 80), 8)
    ...
    def alpha_064(self):
        n = 4
        m = 14
        temp1 = bt.AZ_Rolling_corr(self.avg_price.rank(axis=1, pct=1), self.volume.rank(axis=1, pct=1), 4)
        temp1 = temp1.iloc[-n:, :]
        ...
        temp2 = bt.AZ_Rolling_corr(temp2, bt.AZ_Rolling_mean(self.volume, 60), 4)
    ...
    def alpha_071(self):
        ...
        data = self.close - bt.AZ_Rolling_mean(self.close, 24) / bt.AZ_Rolling_mean(self.close, 24)
    ...
    #     # Written by Jianing Lu
    #     data1 = bt.AZ_Rolling_max(self.high, 6) - self.close
    #     data2 = bt.AZ_Rolling_max(self.high, 6) - bt.AZ_Rolling_min(self.low, 6)
    ...
    #     # 未实现
    #     #    data1 = bt.AZ_Rolling_corr(self.close, self.volume, window=10).iloc[-16:,:]
    ...
    def alpha_074(self):
        ...
        data1 = bt.AZ_Rolling_sum((self.low * 0.35 + self.avg_price * 0.65), 20)
        data2 = bt.AZ_Rolling_mean(self.volume, 40)
        rank1 = bt.AZ_Rolling_corr(data1, data2, 7).rank(axis=1, pct=True)
        data3 = self.avg_price.rank(axis=1, pct=True)
        data4 = self.volume.rank(axis=1, pct=True)
        rank2 = bt.AZ_Rolling_corr(data3, data4, 6).rank(axis=1, pct=True)
    ...
    def alpha_077(self):
        ...
        data2 = bt.AZ_Rolling_corr((self.high + self.low) / 2, bt.AZ_Rolling_mean(self.volume, 40), 3).iloc[-6:, :]
    ...
    def alpha_078(self):
        ...
        data1 = (self.high + self.low + self.close) / 3 - \
                bt.AZ_Rolling_mean((self.high + self.low + self.close) / 3, 12)
        data2 = abs(self.close - bt.AZ_Rolling_mean((self.high + self.low + self.close) / 3, 12))
        data3 = bt.AZ_Rolling_mean(data2, 12) * 0.015
    ...
    def alpha_91(self):
        ...
        mean = bt.AZ_Rolling_mean(self.volume, 40)
    ...
    def alpha_92(self):
        ...
        rank1 = (bt.AZ_Rolling_apply(delta, 3, self.func_decaylinear)).rank(axis=1, pct=True)
        rank2 = bt.AZ_Rolling_apply(
            bt.AZ_Rolling_apply(self.volume.rolling(180).mean().rolling(13).corr(self.close).abs(),
                                5, self.func_decaylinear),
            15, self.func_rank)
    ...
    def alpha_99(self):
        ...
        alpha = (-bt.AZ_Rolling_cov(self.close.rank(axis=1, pct=True), self.volume.rank(axis=1, pct=True),
    ...
    def alpha_113(self):
        ...
        rank1 = (bt.AZ_Rolling_sum(data1, window=20) / 20).rank(axis=1, pct=True)
        corr1 = self.close.iloc[-2:, :].corrwith(self.volume.iloc[-2:, :])
        data2 = bt.AZ_Rolling_sum(self.close, window=5)
        data3 = bt.AZ_Rolling_sum(self.close, window=20)
    ...
    def alpha_114(self):
        ...
        # writen by Chen Cheng
        data1 = (self.high - self.low) / (bt.AZ_Rolling_sum(self.close, window=5) / 5)
        rank1 = (data1.iloc[-2, :]).rank(axis=0, pct=True)
        rank2 = ((self.volume.rank(axis=1, pct=True)).rank(axis=1, pct=True)).iloc[-1, :]
        data2 = (((self.high - self.low) / (bt.AZ_Rolling_sum(self.close, window=5) / 5)) / (
    ...
    def alpha_115(self):
        ...
        tsrank1 = bt.AZ_Rolling_apply((self.high + self.low) / 2, 4, self.func_rank)
        tsrank2 = bt.AZ_Rolling_apply(self.volume, 10, self.func_rank)
    ...
    def alpha_118(self):
        ...
        data3 = bt.AZ_Rolling_sum(data1, window=20)
        data4 = bt.AZ_Rolling_sum(data2, window=20)
    ...
    def alpha_119(self):
        ...
        rank1 = bt.AZ_Rolling_apply(corr1, 7, self.func_decaylinear).rank(axis=1, pct=True)
        rank2 = self.open_price.rank(axis=1, pct=True)
        rank3 = (self.volume.rolling(window=15).mean()).rank(axis=1, pct=True)
        rank4 = bt.AZ_Rolling_apply(rank2.rolling(window=21).corr(rank3).rolling(window=9).min(), 7, self.func_rank)
        rank5 = bt.AZ_Rolling_apply(rank4, 8, self.func_decaylinear).rank(axis=1, pct=True)
    ...
    #     data = pd.ewma(pd.ewma(pd.ewma(log_close, span=12, adjust=False), span=12, adjust=False),
    ...
    def alpha_125(self):
        ...
        # writen by Lin Qitao
        data1 = bt.AZ_Rolling_corr(self.avg_price, self.volume.rolling(80).mean(), window=17)
    ...
    def alpha_130(self):
        ...
        data3 = bt.AZ_Rolling_corr(data1, data2, window=9)
        ...
        data1 = self.avg_price.rank(axis=1, pct=True)
        data2 = self.volume.rank(axis=1, pct=True)
        data3 = bt.AZ_Rolling_corr(data1, data2, window=7)
    ...
    def alpha_138(self):
        ...
        data3 = bt.AZ_Rolling_corr(data1, data2, window=5).rolling(19).apply(self.func_rank)
    ...
    #     data3 = bt.AZ_Rolling_corr(data1, data2, window=8)
    ...
    def alpha_142(self):
        ...
        rank3 = (self.volume / self.volume.rolling(20).mean()).iloc[-5:, :].rank(axis=0, pct=True).iloc[-1, :]\
            .rank(pct=True)
    ...
    def alpha_145(self):
        ...
        alpha = (self.volume.iloc[-9:, :].mean() - self.volume.iloc[-26:, :].mean()) \
    ...
    #     # @author: fuzhongjie
    #     data1 = bt.AZ_Rolling_mean(
    #         (pd.ewma(((self.close / self.close.shift(9)).shift()), span=17, adjust=False)).shift(),
    #         12)
    #     data2 = bt.AZ_Rolling_mean(
    #         (pd.ewma(((self.close / self.close.shift(9)).shift()), span=17, adjust=False)).shift(),
    #         26)
    ...
    def alpha_153(self):
        ...
        alpha = ((bt.AZ_Rolling_mean(self.close, 3) + bt.AZ_Rolling_mean(self.close, 6) +
                  bt.AZ_Rolling_mean(self.close, 12) + bt.AZ_Rolling_mean(self.close, 24)) / 4).iloc[-1, :]
        alpha = alpha.dropna()
        return alpha
    ...
    def alpha_154(self):
        ...
        alpha = (self.avg_price - bt.AZ_Rolling_min(self.avg_price, 16)).iloc[-1, :] < self.avg_price.iloc[-18:, :]\
            .corrwith((bt.AZ_Rolling_mean(self.volume, 180)).iloc[-18:, :])
        alpha = alpha.dropna()
        return alpha
    ...
    def alpha_156(self):
        ...
        rank1 = (bt.AZ_Rolling_apply(self.avg_price - self.avg_price.shift(5), 3, self.func_decaylinear)).rank(axis=1,
                                                                                                               pct=True)
        rank2 = bt.AZ_Rolling_apply(
    ...
    def alpha_157(self):
        ...
        cond_min = rank2 > 5
        rank2[cond_min] = 5
        tsrank1 = bt.AZ_Rolling_apply((-((self.close / self.prev_close) - 1)).shift(6), 5, self.func_rank)
    ...
    def alpha_159(self):
        ...
        # (close-sum(min(low,delay(close,1)),24))/sum(max(high,delay(close,1))
        ...
        data3[~cond] = data4
        # 计算出公式核心部分x
        x = ((self.close - bt.AZ_Rolling_sum(data1, 6)) / bt.AZ_Rolling_sum((data2 - data1), 6)) * 12 * 24
        # 计算出公式核心部分y
        y = ((self.close - bt.AZ_Rolling_sum(data1, 12)) / bt.AZ_Rolling_sum((data2 - data1), 12)) * 6 * 24
        # 计算出公式核心部分z
        z = ((self.close - bt.AZ_Rolling_sum(data1, 24)) / bt.AZ_Rolling_sum((data2 - data1), 24)) * 6 * 24
    ...
    #     data1 = bt.AZ_Rolling_std(self.close, 20)
    ...
    def alpha_161(self):
        ...
        cond = data1 > data3
        data1[~cond] = data3
        alpha = (bt.AZ_Rolling_mean(data1, 12)).iloc[-1, :]
        alpha = alpha.dropna()
        return alpha
    ...
    def alpha_163(self):
        ...
        data1 = (-1) * (self.close / self.close.shift() - 1) * bt.AZ_Rolling_mean(self.volume, 20) * self.avg_price * (
    ...
    # def alpha_164(self):
    #     # writen by Chen Cheng
    #     # sma((((close>delay(close,1))?1/(close-delay(close,1)):1)-min(((close>delay(close,1))?
    #     # 1/(close/delay(close,1)):1),12))/(high-low)*100,13,2)
    ...
    def alpha_167(self):
        ...
        cond = (data1 < 0)
        data1[cond] = 0
        data2 = (bt.AZ_Rolling_sum(data1, 12)).iloc[-1, :]
        alpha = data2
        alpha = alpha.dropna()
        return alpha
    ...
    def alpha_168(self):
        ...
        data1 = (-1 * self.volume) / bt.AZ_Rolling_mean(self.volume, 20)
        alpha = data1.iloc[-1, :]
        alpha = alpha.dropna()
        return alpha
    ...
    #     data3 = bt.AZ_Rolling_mean(data2, 12) - bt.AZ_Rolling_mean(data2, 26)
    ...
    def alpha_170(self):
        ...
        data2 = bt.AZ_Rolling_mean(self.volume, 20)
        x = (data1 * self.volume) / data2
        # 计算公式中间部分，Y
        data3 = (self.high - self.close).rank(axis=0, pct=True)
        data4 = bt.AZ_Rolling_mean(self.high, 5)
    ...
    def alpha_172(self):
        ...
        sum_tr14 = bt.AZ_Rolling_sum(tr, 14)
        cond3 = ld > 0
        cond4 = ld > hd
        cond3[~cond4] = False
        data1 = ld
        data1[~cond3] = 0
        sum1 = bt.AZ_Rolling_sum(data1, 14) * 100 / sum_tr14
        cond5 = hd > 0
        cond6 = hd > ld
        cond5[~cond6] = False
        data2 = hd
        data2[~cond5] = 0
        sum2 = bt.AZ_Rolling_sum(data2, 14) * 100 / sum_tr14
        alpha = bt.AZ_Rolling_mean((sum1 - sum2).abs() / (sum1 + sum2) * 100, 6).iloc[-1, :]
        alpha = alpha.dropna()
        return alpha
    ...
    #     data2 = bt.AZ_Rolling_std(self.close, 20)
    #     data2[~cond] = 0
    ...
    def alpha_175(self):
        ...
        # 求和，输出
        data4 = (bt.AZ_Rolling_mean(data3, window=6)).iloc[-1, :]
        alpha = data4
        alpha = alpha.dropna()
        return alpha
    ...
    def alpha_176(self):
        ...
        # 获取数据，求出RANK1
        data1 = (self.close - bt.AZ_Rolling_min(self.low, window=12)) / (
                bt.AZ_Rolling_max(self.high, window=12) - bt.AZ_Rolling_min(self.low, window=12))
    ...
    def alpha_179(self):
        ...
        data3 = (bt.AZ_Rolling_mean(self.volume, window=50)).rank(axis=0, pct=True)
    ...
    def alpha_180(self):
        ...
        ma = bt.AZ_Rolling_mean(self.volume, window=20)
        cond = (ma < self.volume).iloc[-20:, :]
        sign = self.close.diff(7)
        sign[sign.iloc[:, :] < 0] = -1
        sign[sign.iloc[:, :] > 0] = 1
        sign[sign.iloc[:, :] == 0] = 0
        left = (((self.close.diff(7).abs()).iloc[-60:, :].rank(axis=0, pct=True) * (-1)).iloc[-20:, :] *
    ...
    #     count = bt.AZ_Rolling_apply(cond, 20, self.count_cond_182)
    ...
    # @author: fuzhongjie
    def alpha_186(self):
        # (MEAN(ABS(SUM((LD>0 & LD>HD)?LD:0,14)*100/SUM(TR,14)-SUM((HD>0 & HD>LD)?HD:0,14)
        # *100/SUM(TR,14))/(SUM((LD>0 & LD>HD)?LD:0,14)*100/SUM(TR,14)+SUM((HD>0 & HD>LD)?HD:0,14)
        # *100/SUM(TR,14))*100,6)+DELAY(MEAN(ABS(SUM((LD>0 & LD>HD)?LD:0,14)*100/SUM(TR,14)
        # -SUM((HD>0 & HD>LD)?HD:0,14)*100/SUM(TR,14))/(SUM((LD>0 & LD>HD)?LD:0,14)*100/SUM(TR,14)
        ...
        data2[~cond5] = 0
        sum2 = bt.AZ_Rolling_sum(data2, 14) * 100 / sum_tr14
        mean1 = bt.AZ_Rolling_mean((sum1 - sum2).abs() / (sum1 + sum2) * 100, 6)
    ...
    def alpha_189(self):
        ...
        # writen by fuzhongjie/chencheng
        ma6 = bt.AZ_Rolling_mean(self.close, window=6)  # 6日移动平均线
        alpha = bt.AZ_Rolling_mean((self.close - ma6).abs(), window=6).iloc[-1, :]
        alpha = alpha.dropna()
        return alpha
    ...
    def alpha_191(self):
        ...
        # writen by fuzhongjie/chencheng
        volume_avg = bt.AZ_Rolling_mean(self.volume, window=20)
