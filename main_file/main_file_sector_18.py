...
class FactorTestSector(mf.FactorTest):
    ...
    def load_intra_factor(self, file_name):
        load_path = '/mnt/mfs/temp/dat_jerry/VR'
    ...
    def part_test_index_3_(self, key, name_1, name_2, name_3, log_save_file, result_save_file, total_para_num):
        ...
        change_factor = self.load_intra_factor(name_1)
        ratio_factor = self.load_intra_factor(name_2)
    ...
    def single_test(self, fun_name, name1, name2, name3):
        ...
        change_factor = self.load_intra_factor(name1)
        ratio_factor = self.load_intra_factor(name2)
...
def main_fun(sector_name, hold_time, if_only_long, time_para_dict):
    ...
    intra_path = '/mnt/mfs/temp/dat_jerry/VR'
    intra_factor_list = os.listdir(intra_path)
    ...
    main.test_index_3_(intra_factor_list, intra_factor_list, tech_list, pool_num, suffix_name=suffix_name)
