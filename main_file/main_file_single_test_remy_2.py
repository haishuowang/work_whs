...
class FactorTestSector(mf.FactorTest):
    ...
    def part_test_index(self, key, name_1, log_save_file, result_save_file, total_para_num):
        ...
        factor_1 = self.load_remy_factor(name_1, self.sector_name)
        ...
        *result_list, pnl_df = filter_all(self.cut_date, daily_pos, self.return_choose,
        ...
        pnl_save_path = f'/media/hdd2/dat_whs/data/single_factor_pnl/{self.sector_name}'
    ...
    def single_test_c(self, name_list, buy_sell_way_list):
        ...
        for i in range(len(name_list)):
            ...
            tmp_factor = self.load_remy_factor(tmp_name)
...
def main_fun(sector_name, hold_time, if_only_long, time_para_dict):
    ...
    remy_factor_list = os.listdir(factor_path)
    # from random import sample
    # remy_factor_list = sample(remy_factor_list, 400)
    pool_num = 28
    main.test_index(remy_factor_list, pool_num, suffix_name='single_test')
