...
def config_test():
    factor_str = 'TotRev_and_mcap_intdebt_QYOY_Y3YGR_0.3|REMWB.02|R_NetInc_s_QYOY' \
                 '|RZRQYE_p20d_col_extre_0.2|lsgg_num_df_5|REMFF.33|R_NetInc_TotProfit_s_First' \
                 '|R_ParentProfit_s_POP_First|R_WorkCapital_QYOY_and_QTTM_0.3|R_ASSETDEVALUELOSS_s_QYOY_and_QTTM_0.3'
    info_str = 'market_top_300to800plus_industry_10_15|20|False'
    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA16'
