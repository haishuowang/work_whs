...
def config_test():
    factor_str = 'continue_ud_p20d|aadj_r_p10d_col_extre_0.2|pnd_continue_pct_ud_alpha345_1_0|evol_p60d' \
                 '|turn_p60d_0.2|continue_ud_p90d|wgt_return_p20d_0.2|TVOL_p20d_col_extre_0.2' \
                 '|aadj_r_p20d_col_extre_0.2'
    info_str = 'market_top_300plus_industry_45_50|20|False'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSTECHNM01'
