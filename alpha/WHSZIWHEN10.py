...
def config_test():
    factor_str = 'turn_p150d_0.18|ab_sale_mng_exp|REMFF.24|RZCHE_row_extre_0.2|R_ParentProfit_s_YOY_First' \
    ...
    plot_send_result(pnl_df.iloc[-100:], bt.AZ_Sharpe_y(pnl_df), alpha_name)
