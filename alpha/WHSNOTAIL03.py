...
def main_fun():
    str_1 = 'index_000905|20|False|0.2'
    exe_str = 'bar_num_7_df|col_zscore|60_-1.0@add_fun@R_ROE_s_First|col_zscore|120_1.0@add_fun@' \
              'RZCHE|pnd_vol|60_-1.0@add_fun@R_ParentProfit_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'R_OperCost_sales_s_First|pnd_vol|120_-1.0@add_fun@' \
              'R_TangAssets_TotLiab_QTTM|col_zscore|60_-1.0@add_fun@RZYE|pnd_vol|20_-1.0@add_fun@' \
              'R_TotRev_TTM_QSD4Y|pnd_vol|5_1.0@add_fun@R_TangAssets_First|pnd_vol|5_1.0@add_fun@' \
              'news_num_df_20|pnd_vol|120_-1.0@add_fun@R_OPEX_sales_TTM_First|pnd_vol|120_-1.0'
