...
if __name__ == '__main__':
    ...
    exe_list = ['add', (['sub', (['add', (['sub', ('PEG_OPERATEREVE_3Y', ['max_fun', ('stock_tab4_1',), (41,)]), ()],
                ['sub', ('PEG_OPERATEREVE_3Y', ['diff', ('R_NetIncRecur_s_First',), (41,)]), ()]), ()],
                ['diff', ('R_NetIncRecur_s_First',), (41,)]), ()], ['add', (['sub', (['diff', ('R_NetCf_TTM_QSD4Y',),
                (127,)], ['diff', ('R_NetIncRecur_s_First',), (41,)]), ()], ['sub', (['sub', (['diff',
                ('R_NetCf_TTM_QSD4Y',), (127,)], ['diff', ('R_NetIncRecur_s_First',), (41,)]), ()], ['min_fun',
                (['max_fun', ('stock_tab4_1',), (41,)],), (41,)]), ()]), ()]), ()]
