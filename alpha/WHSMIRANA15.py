...
def config_test():
    factor_str = 'R_NetInc_s_QYOY|REMTK.29|RQCHL_p345d_continue_ud|REMWB.04|REMTK.36|aadj_r_p10d_col_extre_0.2' \
                 '|R_FairVal_TotProfit_QYOY|R_OPCF_TTM_QYOY|REMTK.26|ab_ab_pre_rec'
    info_str = 'market_top_300to800plus_industry_20_25_30_35|20|False'
    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA15'
