...
def main_fun():
    ...
    exe_str = 'R_RevenuePS_s_First|col_zscore|120_1.0@add_fun@TURNRATE|row_zscore_-1.0@add_fun@' \
              'aadj_p|row_zscore_-1.0@add_fun@R_NetROA1_First|col_zscore|120_1.0@add_fun@' \
              'lsgg_num_df_60|col_zscore|120_-1.0@add_fun@R_CurrentLiabInt0_QTTM|col_zscore|60_1.0@add_fun@' \
              'R_OperProfit_s_YOY_First|col_zscore|120_1.0@add_fun@stock_tab2_7|pnd_vol|60_-1.0@add_fun@' \
              'R_EPS_s_YOY_First|col_zscore|60_1.0@add_fun@R_OperCost_sales_s_First|pnd_vol|120_-1.0@add_fun@' \
              'R_TotRev_TTM_Y3YGR|col_zscore|120_1.0'
