...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_PARENTNETPROFIT_5Y|col_zscore|60_-1.0@add_fun@R_FairValChgPnL_s_First|pnd_vol|60_1.0@add_fun@' \
              'PEG_EBIT_3Y|row_zscore_-1.0@add_fun@R_Revenue_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'TVALCNY|pnd_vol|20_-1.0@add_fun@R_TangAssets_TotLiab_QTTM|col_zscore|120_-1.0@add_fun@' \
              'TVALCNY|pnd_vol|5_-1.0@add_fun@R_EBITDA_IntDebt_QTTM|pnd_vol|5_1.0@add_fun@' \
              'R_TotRev_TTM_Y3YGR|pnd_vol|120_1.0@add_fun@R_ROEWRecur_First|row_zscore_-1.0@add_fun@' \
              'R_EBIT_TTM_QTTM|pnd_vol|120_1.0'
    filter_i = 1
