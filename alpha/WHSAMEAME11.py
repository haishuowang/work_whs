...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_EBIT_3Y|col_zscore|60_-1.0@add_fun@R_ParentProfit_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'PEG_OPERATEREVE_3Y|row_zscore_-1.0@add_fun@R_AssetDepSales_s_First|pnd_vol|60_-1.0@add_fun@' \
              'R_Tax_TotProfit_QTTM|pnd_vol|120_-1.0@add_fun@bar_num_7_df|row_zscore_-1.0@add_fun@' \
              'R_NetWorkCapital_QTTM|row_zscore_1.0@add_fun@bar_num_12_df|row_zscore_-1.0@add_fun@' \
              'TURNRATE|pnd_vol|5_-1.0@add_fun@R_NetAssets_s_POP_First|pnd_vol|120_1.0@add_fun@RZYE|row_zscore_-1.0'
    filter_i = 1
