...
class FactorTestSector(FactorTest):
    ...
    def load_whs_factor(self, file_name):
        # load_path = f'/mnt/mfs/DAT_EQT/EM_Funda/dat_whs'
    ...
    def single_test(self, fun_name, name1, name2, name3):
        ...
        factor_1 = self.load_whs_factor(name1)
        factor_2 = self.load_whs_factor(name2)
        factor_3 = self.load_tech_factor(name3)
...
def config_test():
    # config_name = 'market_top_300to800plus_industry_10_15_True_20190105_0015_hold_5__19'
    config_name = 'market_top_300to800plus_industry_10_15_True_20190106_0028_hold_20__19'
