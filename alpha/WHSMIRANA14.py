...
def config_test():
    factor_str = 'REMFF.07|REMFF.30|RZCHE_row_extre_0.2|turn_p150d_0.18|REMTK.32|return_p20d_0.2|REMTK.26' \
                 '|R_Revenue_s_YOY_First|evol_p10d|aadj_r_p120d_col_extre_0.2|R_CFO_s_YOY_First_and_QTTM_0.3'
    info_str = 'market_top_300to800plus_industry_20_25_30_35|20|True'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA14'
