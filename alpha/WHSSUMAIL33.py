...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_EBIT_3Y|col_zscore|120_-1.0@add_fun@RZYE|row_zscore_-1.0@add_fun@' \
              'R_NetWorkCapital_QTTM|col_zscore|5_-1.0@add_fun@R_Revenue_s_YOY_First|pnd_vol|60_1.0@add_fun@' \
              'R_CurrentLiabInt0_QTTM|pnd_vol|5_-1.0'
