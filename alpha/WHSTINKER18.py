...
def config_test():
    # factor_str = 'REMRATIO.VAGR01.021|REMRATIO.ADCH01.056|REMRATIO.ADCH01.020|REMRATIO.VAGR01.077|REMRATIO.ADCH01.041'
    # info_str = 'market_top_300to800plus_industry_10_15|5|False'

    # factor_str = 'REMRATIO.ADJV02.037|REMRATIO.ADCH01.021|REMRATIO.VAGR01.051|REMRATIO.ADCH01.019|REMRATIO.ADCH01.082'
    # info_str = 'market_top_300to800plus_industry_20_25_30_35|20|False'

    factor_str = 'REMRATIO.ADJV01.050|REMRATIO.ADCH02.083|REMRATIO.ADCH02.084|REMRATIO.ADCH02.082|REMRATIO.VAGR02.017'
    info_str = 'market_top_300to800plus_industry_20_25_30_35|5|False'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSTINKER18'
