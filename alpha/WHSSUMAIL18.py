...
if __name__ == '__main__':
    ...
    exe_str = 'R_NetIncRecur_s_First|row_zscore_1.0@add_fun@PEG_EBIT_3Y|col_zscore|60_-1.0@add_fun@' \
              'R_SalesGrossMGN_First|pnd_vol|120_-1.0@add_fun@R_GSCF_TTM_QTTM|col_zscore|20_1.0@add_fun@' \
              'R_OPCF_sales_s_First|pnd_vol|120_-1.0@add_fun@bar_num_12_df|col_zscore|120_-1.0@add_fun@' \
              'R_WorkCapital_QTTM|col_zscore|5_-1.0@add_fun@R_NetProfit_sales_s_First|pnd_vol|5_1.0@add_fun@' \
              'aadj_p|pnd_vol|5_-1.0@add_fun@R_OPCF_TotDebt_QTTM|pnd_vol|60_1.0@add_fun@' \
              'R_NetROA_TTM_First|pnd_vol|20_-1.0'
