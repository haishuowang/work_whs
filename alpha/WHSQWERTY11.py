...
def main_fun():
    ...
    exe_str = 'R_OperProfit_s_YOY_First|col_zscore|60_1.0@add_fun@R_SalesGrossMGN_First|col_zscore|60_1.0@add_fun@' \
              'R_OperProfit_sales_Y3YGR|pnd_vol|120_-1.0@add_fun@RZMRE|pnd_vol|60_-1.0@add_fun@' \
              'R_NetProfit_sales_s_First|pnd_vol|60_-1.0@add_fun@RZMRE|pnd_vol|5_-1.0@add_fun@' \
              'R_TotCapital_First|col_zscore|60_1.0@add_fun@R_CFO_s_YOY_First|pnd_vol|60_-1.0@add_fun@' \
              'stock_tab1_5|pnd_vol|60_-1.0@add_fun@stock_tab1_5|pnd_vol|120_-1.0@add_fun@' \
