...
def main_fun():
    ...
    exe_str = 'R_EPS_s_YOY_First|row_zscore_1.0@add_fun@R_NetAssets_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'R_SalesGrossMGN_s_First|col_zscore|120_1.0@add_fun@restricted_shares|pnd_vol|60_-1.0@add_fun@' \
              'R_GSCF_TTM_QTTM|row_zscore_1.0@add_fun@R_SalesGrossMGN_QTTM|pnd_vol|60_-1.0@add_fun@' \
              'R_NetCashflowPS_s_First|row_zscore_1.0@add_fun@R_OperProfit_sales_Y3YGR|row_zscore_1.0@add_fun@' \
              'R_FairValChgPnL_s_First|row_zscore_1.0@add_fun@RZCHE|pnd_vol|60_-1.0@add_fun@' \
              'R_INCOMETAX_QTTM|pnd_vol|60_1.0'
