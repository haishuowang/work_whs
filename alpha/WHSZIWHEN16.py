...
def config_test():
    factor_str = 'R_GrossProfit_TTM_QYOY_and_QTTM_0.3|wgt_return_p20d_0.2|TotRev_and_mcap_Y3YGR_Y5YGR_0.3' \
                 '|REMTK.32|aadj_r_p60d_col_extre_0.2|continue_ud_p100d|OPCF_and_mcap_intdebt_Y3YGR_Y5YGR_0.3' \
                 '|R_TangAssets_IntDebt_QYOY_and_QTTM_0.3|tab2_9_row_extre_0.3' \
                 '|R_OTHERLASSET_QYOY_and_QTTM_0.3|lsgg_num_df_60'
    info_str = 'market_top_300plus_industry_45_50|5|False'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSZIWHEN16'
