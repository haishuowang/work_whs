...
if __name__ == '__main__':
    ...
    exe_str = 'R_NetAssets_s_YOY_First|col_zscore|120_1.0@add_fun@PEG_OPERATEREVE_5Y|row_zscore_-1.0@add_fun@' \
              'PEG_EBIT_5Y|col_zscore|120_-1.0@add_fun@TVALCNY|pnd_vol|120_-1.0@add_fun@' \
              'TURNRATE|pnd_vol|60_-1.0@add_fun@aadj_p_OPEN|pnd_vol|5_-1.0@add_fun@' \
              'R_Tax_TotProfit_s_First|pnd_vol|60_-1.0@add_fun@R_Cashflow_s_YOY_First|row_zscore_1.0@add_fun@' \
              'R_WorkCapital_First|row_zscore_1.0@add_fun@R_NetWorkCapital_QSD4Y|pnd_vol|120_1.0@add_fun@' \
              'R_TotRev_s_POP_First|pnd_vol|120_1.0'
    filter_i = 1
