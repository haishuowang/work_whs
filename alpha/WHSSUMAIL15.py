...
if __name__ == '__main__':
    ...
    exe_str = 'R_ROE_s_First|row_zscore_1.0@add_fun@PEG_EBIT_5Y|col_zscore|120_-1.0@add_fun@' \
              'RZMRE|pnd_vol|60_-1.0@add_fun@PEG_EBIT_5Y|pnd_vol|60_-1.0@add_fun@' \
              'PS_TTM|pnd_vol|60_-1.0@add_fun@PEG_OPERATEREVE_5Y|col_zscore|60_-1.0@add_fun@' \
              'R_TotRev_TTM_Y3YGR|col_zscore|120_1.0@add_fun@R_TangAssets_First|pnd_vol|60_1.0@add_fun@' \
              'R_SalesNetMGN_s_First|pnd_vol|5_1.0@add_fun@R_SUMLIAB_Y3YGR|col_zscore|20_-1.0@add_fun@' \
              'R_Revenue_s_YOY_First|row_zscore_1.0'
