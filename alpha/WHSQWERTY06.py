...
def main_fun():
    ...
    str_1 = 'market_top_300plus_industry_20_25_30_35|10|False|0.1'

    exe_str = 'R_TotAssets_s_YOY_First|pnd_count_down|20_1.0@add_fun@' \
              'R_AssetDepSales_QTTM|pnd_count_down|60_1.0@add_fun@' \
              'R_OperProfit_sales_s_First|row_zscore_1.0@add_fun@' \
              'TVALCNY|pnd_count_down|60_1.0@add_fun@' \
              'aadj_r|col_zscore|5_-1.0@add_fun@' \
              'R_OperCost_sales_s_First|pnd_count_down|5_1.0@add_fun@' \
              'PS_TTM|pnd_count_down|60_1.0@add_fun@' \
              'news_num_df_60|pnd_vol|120_-1.0@add_fun@' \
              'PS_TTM|col_zscore|60_-1.0@add_fun@' \
              'R_TangAssets_QTTM|col_zscore|120_1.0@add_fun@' \
              'aadj_p|row_zscore_-1.0'
