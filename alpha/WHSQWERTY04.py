...
def main_fun():
    ...
    str_1 = 'market_top_300plus_industry_45_50|20|False|0.2'
    exe_str = 'sell_summary_key_word|pnd_count_down|60_-1.0@add_fun@' \
              'R_EMPLOYEEPAY_QTTM|row_zscore_1.0@add_fun@' \
              'R_ROEWRecur_First|col_zscore|120_1.0@add_fun@' \
              'R_RevenuePS_s_First|col_zscore|60_1.0@add_fun@' \
              'R_NetWorkCapital_QTTM|row_zscore_1.0@add_fun@' \
              'R_NetROA_TTM_First|pnd_vol|5_-1.0@add_fun@' \
              'R_TotRev_TTM_QSD4Y|col_zscore|120_-1.0@add_fun@' \
              'R_DebtAssets_QTTM|pnd_count_down|120_-1.0@add_fun@' \
              'aadj_p|col_zscore|20_-1.0 '
