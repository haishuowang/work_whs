...
class FactorTest:
    ...
    def load_return_data(self):
        if self.return_file == 'aadj_r0940_1000':
...
def config_test():
    config_name = 'market_top_300to800plus_True_20181227_0632_hold_20__17'
    ...
    pot = bt.AZ_Pot(sum_pos_df_new, pnl_df.cumsum().iloc[-1])
