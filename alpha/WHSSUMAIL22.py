...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_EBIT_5Y|col_zscore|120_-1.0@add_fun@PEG_PARENTNETPROFIT_3Y|col_zscore|5_-1.0@add_fun@' \
              'R_NetROA_s_First|row_zscore_1.0@add_fun@RZYE|row_zscore_-1.0@add_fun@' \
              'R_SalesCost_s_First|pnd_vol|20_1.0@add_fun@R_Tax_TotProfit_QTTM|pnd_vol|5_-1.0@add_fun@' \
              'R_OPCF_sales_s_First|pnd_vol|20_1.0@add_fun@R_WorkCapital_First|pnd_vol|5_1.0@add_fun@' \
              'RQCHL|pnd_vol|120_-1.0@add_fun@R_ROETrig_First|col_zscore|60_-1.0'
