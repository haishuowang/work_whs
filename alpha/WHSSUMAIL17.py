...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_EBIT_3Y|col_zscore|120_-1.0@add_fun@R_GSCF_TTM_QTTM|col_zscore|5_1.0@add_fun@' \
              'R_TotRev_TTM_QTTM|row_zscore_1.0@add_fun@RZYE|pnd_vol|20_-1.0@add_fun@' \
              'R_SUMASSET_First|col_zscore|5_1.0@add_fun@ab_sale_mng_exp|pnd_vol|60_1.0@add_fun@' \
              'R_CurrentAssetsTurnover_QTTM|pnd_vol|20_-1.0'
