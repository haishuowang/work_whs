...
def main_fun():
    ...
    exe_str = 'R_OperProfit_s_YOY_First|row_zscore_1.0@add_fun@TURNRATE|pnd_vol|60_-1.0@add_fun@' \
              'R_CurrentLiabInt0_QTTM|col_zscore|60_1.0@add_fun@R_SalesCost_s_First|col_zscore|60_-1.0@add_fun@' \
              'R_DebtAssets_QTTM|pnd_vol|120_-1.0@add_fun@R_NetROA1_First|col_zscore|60_1.0@add_fun@' \
              'TVALCNY|pnd_vol|20_-1.0@add_fun@TVALCNY|col_zscore|20_-1.0@add_fun@' \
              'bulletin_num_df_20|pnd_vol|20_-1.0@add_fun@restricted_shares|pnd_vol|60_-1.0@add_fun@' \
              'ab_grossprofit|row_zscore_1.0'
