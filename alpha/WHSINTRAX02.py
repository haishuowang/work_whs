...
def main_fun():
    ...
    exe_str = 'R_AssetDepSales_QTTM|pnd_count_down|5_1.0@add_fun@' \
              'PE_TTM|col_zscore|5_-1.0@add_fun@' \
              'ab_inventory|row_zscore_1.0@add_fun@' \
              'R_OperProfit_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'bulletin_num_df_20|row_zscore_-1.0@add_fun@' \
              'bulletin_num_df_20|pnd_count_down|20_1.0@add_fun@' \
              'bulletin_num_df_20|col_zscore|120_-1.0@add_fun@' \
              'aadj_r|col_zscore|120_-1.0@add_fun@' \
              'stock_tab4_2|pnd_count_down|60_-1.0@add_fun@' \
              'R_FinCf_TTM_QSD4Y|pnd_count_down|60_-1.0@add_fun@' \
              'R_IntDebt_First|pnd_count_down|60_-1.0 '
...
if __name__ == '__main__':
    a = time.time()
    info_df, pnl_df, pos_df = main_fun()
    b = time.time()
    print(b - a)
