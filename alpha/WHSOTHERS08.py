...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_PARENTNETPROFIT_5Y|col_zscore|60_-1.0@add_fun@PEG_PARENTNETPROFIT_5Y|pnd_vol|60_-1.0@add_fun@' \
              'PEG_EBIT_5Y|row_zscore_-1.0@add_fun@R_OperCost_sales_s_First|col_zscore|60_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_3Y|pnd_vol|60_-1.0@add_fun@PEG_PARENTNETPROFIT_5Y|pnd_vol|120_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_3Y|row_zscore_-1.0@add_fun@PEG_PARENTNETPROFIT_5Y|row_zscore_-1.0@add_fun@' \
              'R_WorkCapital_QSD4Y|col_zscore|20_-1.0@add_fun@R_Tax_TotProfit_s_First|pnd_vol|120_-1.0@add_fun@' \
              'R_ParentProfit_s_POP_First|pnd_vol|20_-1.0'
