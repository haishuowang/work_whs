...
class FactorTestResult(FactorTestBase):
    ...
    def load_mix_data(self, file_name):
        if type(file_name) is str:
            ...
            target_df = getattr(self, fun_name)(*factor_df_list, *para_list)
            # zcore 根据用到的数据增加权重
            target_df = self.row_zscore(target_df, self.sector_df) * len(factor_name_list)
        return target_df
    ...
    def get_pnl_df(self, file_name, cut_date, percent):
        ...
        if self.if_only_long:
            ...
            print(info_df_l['sp_in'], info_df_s['sp_in'])
...
if __name__ == '__main__':
    ...
    exe_list = ['sub', (['mul', (['ma', (['sub', (['sub', (['div', ('stock_tab1_1', 'R_NetWorkCapital_QSD4Y'), ()], 'stock_tab2_9'), ()], ['max_fun', ('stock_tab2_9',), (41,)]), ()],), (127,)], ['std', (['shift', (['mul', ('buy_key_title__word', 'stock_tab2_9'), ()],), (17,)],), (41,)]), ()], ['shift', (['add', (['add', (['add', (['add', (['sub', (['sub', ('stock_tab2_9', ['div', ('stock_tab2_8', 'R_EMPLOYEEPAY_QTTM'), ()]), ()], ['min_fun', ('aadj_p_LOW',), (127,)]), ()], ['mul', ('RQYE', 'stock_tab2_9'), ()]), ()], ['mul', ('buy_key_title__word', 'stock_tab2_9'), ()]), ()], ['shift', (['mul', ('buy_key_title__word', 'stock_tab2_9'), ()],), (17,)]), ()], ['shift', (['add', (['add', (['sub', (['sub', ('stock_tab2_9', ['div', ('stock_tab2_8', 'R_EMPLOYEEPAY_QTTM'), ()]), ()], ['min_fun', ('aadj_p_LOW',), (127,)]), ()], ['mul', ('RQYE', 'stock_tab2_9'), ()]), ()], ['mul', ('buy_key_title__word', 'stock_tab2_9'), ()]), ()],), (41,)]), ()],), (127,)]), ()]
    main_fun(base_info_str, exe_list)
    t2 = time.time()
    print(t2-t1)
