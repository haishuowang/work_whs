...
def main(config_info):
    for sector_name in list(config_info.keys()):
        file_name_list = sorted(list(set(config_info[sector_name])))
...
if __name__ == '__main__':
    factor_str = 'turn_p20d_0.2|TotRev_and_mcap_intdebt_QYOY_Y3YGR_0.3|volume_count_down_p20d|' \
                 'volume_count_down_p10d|R_CFO_TotRev_s_First'
    info_str = 'market_top_300to800plus|20|True'
    config_info = dict()
    config_info['market_top_300to800plus'] = [
        # 'turn_p20d_0.2', 'TotRev_and_mcap_intdebt_QYOY_Y3YGR_0.3', 'volume_count_down_p20d', 'volume_count_down_p10d',
        # 'price_p10d_hl', 'NetProfit_and_mcap_QYOY_Y3YGR_0.3', 'ADX_40_20_10', 'turn_p60d_0.2',
        # 'PS_TTM_p20d_col_extre_0.2', 'TotRev_and_mcap_intdebt_QYOY_Y3YGR_0.3', 'turn_p60d_0.2'
        # 'TotRev_and_mcap_intdebt_QYOY_Y3YGR_0.3', 'volume_count_down_p20d', 'volume_count_down_p10d',
        # 'TotRev_and_mcap_intdebt_Y3YGR_Y5YGR_0.3', 'RZYE_p20d_col_extre_0.2'
        # 'tab4_2_row_extre_0.3', 'vol_p20d', 'ADX_40_20_10', 'RZYE_row_extre_0.2',
        # 'aadj_r_p120d_col_extre_0.2', 'MACD_10_30', 'ADX_40_20_10'
        # 'tab4_2_row_extre_0.3', 'vol_p20d', 'ADX_40_20_10', 'RZYE_row_extre_0.2',
        # 'tab1_1_row_extre_0.3', 'R_ACCOUNTPAY_QYOY_and_QTTM_0.3', 'evol_p20d', 'turn_p20d_0.2'
        # 'OPCF_and_mcap_intdebt_Y3YGR_Y5YGR_0.3', 'price_p10d_hl', 'TVOL_row_extre_0.2', 'evol_p50d'
        # 'vol_p20d', 'NetProfit_and_mcap_intdebt_QYOY_Y3YGR_0.3', 'evol_p10d'
        # 'continue_ud_p120d', 'turn_p20d_0.2'
        # 'MACD_20_60_18', 'RQYE_p10d_col_extre_0.2'
    ...
    #     'R_LTDebt_WorkCap_QYOY_and_QTTM_0.3', 'continue_ud_p100d', 'tab2_9_row_extre_0.3'
    # ]

    config_info['market_top_300to800plus_industry_10_15'] = \
        [
            # 'PE_TTM_p60d_col_extre_0.2', 'OPCF_and_mcap_intdebt_Y3YGR_Y5YGR_0.3',
            # 'R_ASSETDEVALUELOSS_s_QYOY_and_QTTM_0.3'
        ]
    ','
    config_info['market_top_300plus'] = [
        'wgt_return_p20d_0.2'
    ]
