...
if __name__ == '__main__':
    ...
    exe_str = 'R_ROENetIncRecur_s_First|row_zscore_1.0@add_fun@RZYE|row_zscore_-1.0@add_fun@' \
              'R_TotAssets_NBY_First|pnd_vol|20_1.0@add_fun@R_TotAssets_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'R_OPCF_TotDebt_QTTM|pnd_vol|60_1.0@add_fun@R_ParentProfit_s_POP_First|pnd_vol|20_-1.0@add_fun@' \
              'ab_ab_pre_rec|pnd_vol|60_-1.0@add_fun@R_CFO_TotRev_s_First|row_zscore_1.0@add_fun@' \
              'R_NetMargin_s_YOY_First|pnd_vol|20_-1.0'
