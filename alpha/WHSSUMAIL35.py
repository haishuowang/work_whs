...
if __name__ == '__main__':
    ...
    exe_str = 'R_NetROA_s_First|row_zscore_1.0@add_fun@TURNRATE|pnd_vol|60_-1.0@add_fun@' \
              'R_EBITDA_IntDebt_QTTM|pnd_vol|20_1.0@add_fun@PEG_OPERATEREVE_3Y|pnd_vol|5_-1.0@add_fun@' \
              'lsgg_num_df_5|pnd_vol|5_-1.0@add_fun@R_GSCF_TTM_QTTM|col_zscore|5_1.0@add_fun@' \
              'R_OperProfit_sales_Y3YGR|col_zscore|60_1.0@add_fun@R_TotRev_TTM_Y3YGR|col_zscore|120_1.0@add_fun@' \
              'R_NetDebt_First|col_zscore|20_-1.0@add_fun@R_ParentProfit_s_POP_First|pnd_vol|5_1.0@add_fun@' \
              'R_ROETrig_First|pnd_vol|20_1.0'
