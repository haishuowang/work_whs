...
def config_test():
    factor_str = 'REMTK.30|R_RecurNetProft_NetProfit_s_First|suspend|ab_others_rec|vol_p50d|evol_p10d' \
                 '|REMFF.36|REMTK.32|REMWB.11|REMTK.13|BBANDS_100_1'
    info_str = 'market_top_300to800plus|20|True'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA11'
