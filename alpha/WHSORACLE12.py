...
class FactorTestSector(FactorTest):
    ...
    def load_remy_factor(self, file_name):
        load_path = '/media/hdd1/DAT_EQT/EM_Funda/DERIVED_F1'
...
def config_test():
    # config_name = 'market_top_300to800plus_industry_10_15_True_20190105_0357_hold_20__16'
    #
    # config_name = 'market_top_300to800plus_True_20190103_1202_hold_20__16'
    config_name = 'market_top_300to800plus_industry_10_15_True_20190105_0357_hold_20__16'

    config_set = pd.read_pickle(f'/media/hdd1/DAT_PreCalc/PreCalc_whs/config_file/'
                                f'{config_name}.pkl')
    # sorted(list(set(config_set['factor_info'][['name1', 'name2', 'name3']].values.ravel())))
    config_data = config_set['factor_info']
    sector_name = config_set['sector_name']
    alpha_name = 'WHSORACLE12'
    cut_date = '20180601'
    ...
    hold_time = config_set['hold_time']
    lag = 2
    return_file = ''
