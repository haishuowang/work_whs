...
def config_test():
    ...
    factor_str = 'PS_TTM_p10d_col_extre_0.2|REMFF.20|R_ParentProfit_s_YOY_First' \
                 '|RZYE_p60d_col_extre_0.2|vol_p20d|news_num_df_60|evol_p10d|moment_p510d'
    info_str = 'market_top_300to800plus|20|False'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSZIWHEN17'
