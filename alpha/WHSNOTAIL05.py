...
def main_fun():
    str_1 = 'market_top_300to800plus|20|False|0.1'
    exe_str = 'bar_num_12_df|col_zscore|120_-1.0@add_fun@R_NetIncRecur_s_First|row_zscore_1.0@add_fun@' \
              'R_NetAssets_s_POP_First|row_zscore_1.0@add_fun@bulletin_num_df_5|col_zscore|60_-1.0@add_fun@' \
              'RZYE|row_zscore_-1.0@add_fun@PE_TTM|col_zscore|20_-1.0@add_fun@' \
              'R_TotAssets_s_YOY_First|col_zscore|60_1.0@add_fun@R_EMPLOYEEPAY_QTTM|pnd_vol|20_1.0@add_fun@' \
              'R_OPCF_TotDebt_QTTM|pnd_vol|60_1.0@add_fun@R_AssetDepSales_QTTM|pnd_vol|120_-1.0@add_fun@' \
              'funds|pnd_vol|120_1.0'
