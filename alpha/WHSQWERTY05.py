...
def main_fun():
    ...
    exe_str = 'stock_tab2_7|row_zscore_-1.0@add_fun@TURNRATE|pnd_count_down|60_1.0@add_fun@' \
              ...
              'R_TotRev_s_YOY_First|col_zscore|120_1.0@add_fun@R_SalesGrossMGN_First|col_zscore|120_1.0@add_fun@' \
              'lsgg_num_df_20|row_zscore_-1.0@add_fun@R_EPS_s_YOY_First|pnd_count_down|20_1.0@add_fun@' \
              'R_OperProfit_s_POP_First|pnd_count_down|60_1.0@add_fun@stock_tab2_4|pnd_vol|5_1.0@add_fun@' \
              'R_FinExp_sales_s_First|row_zscore_-1.0'
