...
def main_fun():
    ...
    exe_str = 'TURNRATE|pnd_vol|120_-1.0@add_fun@bar_num_7_df|col_zscore|120_-1.0@add_fun@' \
              'PS_TTM|col_zscore|120_-1.0@add_fun@R_OperProfit_sales_s_First|row_zscore_1.0@add_fun@' \
              'R_NetMargin_s_YOY_First|row_zscore_1.0@add_fun@R_AssetDepSales_s_First|col_zscore|120_-1.0@add_fun@' \
              'R_ParentProfit_s_YOY_First|col_zscore|120_1.0@add_fun@lsgg_num_df_20|pnd_vol|60_1.0@add_fun@' \
              'R_SalesGrossMGN_s_Y3YGR|col_zscore|120_1.0@add_fun@lsgg_num_df_5|pnd_vol|120_1.0@add_fun@' \
              'R_NetROA_s_First|col_zscore|60_1.0'
