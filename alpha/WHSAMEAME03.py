...
if __name__ == '__main__':
    ...
    exe_str = 'RZYE|pnd_vol|5_-1.0@add_fun@PEG_PARENTNETPROFIT_3Y|col_zscore|20_-1.0@add_fun@' \
              'R_NetAssets_s_YOY_First|pnd_vol|20_-1.0@add_fun@PEG_OPCF_3Y|pnd_vol|5_-1.0@add_fun@' \
              'R_CurrentLiabInt0_QTTM|col_zscore|120_1.0@add_fun@stock_tab1_7|pnd_vol|60_-1.0@add_fun@' \
              'R_WorkCapital_QTTM|row_zscore_1.0@add_fun@R_SalesGrossMGN_First|col_zscore|120_1.0@add_fun@' \
              'R_NetCf_TTM_QTTM|col_zscore|120_1.0@add_fun@stock_tab2_9|pnd_vol|20_1.0@add_fun@' \
              'R_COMMPAY_QTTM|row_zscore_-1.0'
