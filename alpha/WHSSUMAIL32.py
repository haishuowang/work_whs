...
if __name__ == '__main__':
    ...
    exe_str = 'R_ROE_s_First|row_zscore_1.0@add_fun@R_OperProfit_sales_s_First|pnd_vol|20_1.0@add_fun@' \
              'R_ParentProfit_s_YOY_First|col_zscore|60_1.0@add_fun@PS_TTM|pnd_vol|20_-1.0@add_fun@' \
              'R_NonOperProft_TotProfit_s_First|pnd_vol|60_-1.0@add_fun@R_TangAssets_QTTM|col_zscore|5_-1.0'
