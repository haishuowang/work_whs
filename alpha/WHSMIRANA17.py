...
def config_test():
    factor_str = 'R_NETPROFIT_s_QYOY_and_QTTM_0.3|RZYE_p20d_col_extre_0.2|R_WorkCapital_QYOY_and_QTTM_0.3' \
                 '|R_SalesNetMGN_s_First|evol_p20d|REMTK.11|turn_p150d_0.18|R_OperProfit_s_POP_First|return_p60d_0.2'
    info_str = 'market_top_300to800plus_industry_10_15|20|False'
    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA17'
