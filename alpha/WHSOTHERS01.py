...
def main_fun():
    str_1 = 'index_000300|30|False|0.1'
    exe_str = 'PEG_PARENTNETPROFIT_5Y|col_zscore|60_-1.0@add_fun@PEG_EBIT_3Y|row_zscore_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_3Y|pnd_vol|60_-1.0@add_fun@PEG_PARENTNETPROFIT_3Y|row_zscore_-1.0@add_fun@' \
              'PEG_OPCF_5Y|row_zscore_-1.0@add_fun@PEG_OPCF_3Y|pnd_vol|20_-1.0@add_fun@PEG_OPCF_3Y|row_zscore_-1.0'
