...
def main_fun():
    ...
    exe_str = 'TURNRATE|pnd_vol|60_-1.0@add_fun@R_EPS_s_YOY_First|row_zscore_1.0@add_fun@' \
              'R_ROE_s_First|row_zscore_1.0@add_fun@R_OperProfit_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'R_SalesCost_s_First|col_zscore|60_-1.0@add_fun@R_CurrentAssetsTurnover_QTTM|col_zscore|60_1.0@add_fun@' \
              'lsgg_num_df_60|col_zscore|120_-1.0@add_fun@R_ParentProfit_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'R_GSCF_TTM_QTTM|col_zscore|60_1.0@add_fun@TURNRATE|col_zscore|20_-1.0@add_fun@' \
              'R_CFO_s_YOY_First|col_zscore|60_1.0'
