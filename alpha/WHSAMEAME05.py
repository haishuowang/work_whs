...
if __name__ == '__main__':
    str_1 = 'index_000300|10|False|0.1'
    exe_str = 'PEG_OPERATEREVE_5Y|col_zscore|120_-1.0@add_fun@R_NetAssets_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'R_NetAssets_s_YOY_First|pnd_vol|120_-1.0@add_fun@R_NetROA_TTM_First|pnd_vol|120_-1.0@add_fun@' \
              'R_NetProfit_sales_s_First|pnd_vol|60_-1.0@add_fun@R_Revenue_s_POP_First|col_zscore|120_1.0@add_fun@' \
              'bar_num_7_df|row_zscore_-1.0@add_fun@R_ROEWRecur_First|pnd_vol|120_-1.0@add_fun@' \
              'R_OPCF_TTM_QSD4Y|pnd_vol|20_1.0@add_fun@R_OperProfit_sales_s_First|pnd_vol|120_-1.0@add_fun@' \
              'stock_tab1_1|pnd_vol|20_-1.0'
    filter_i = 1
