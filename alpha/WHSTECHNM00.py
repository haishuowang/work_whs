...
class FactorTestSector(FactorTest):
    ...
    def load_tech_factor(self, file_name):
        if self.root_path == '/media/hdd1/DAT_EQT':
...
def corr_test_fun(pnl_df, alpha_name):
    ...
    print(corr_self[corr_self > 0.50].dropna(axis=0))
...
def config_test():
    ...
    # True True 0.018541 2.113 3.1979 4.4999 41.77 3.58 6.86 3.4996 3.39
    ...
    # True True 0.016304 1.6281 2.5303 3.9597 45.14 3.54 4.59 3.334 3.9
    # factor_str = 'vol_p90d|CCI_p20d_limit_12|aadj_r_p345d_continue_ud|volume_count_down_p20d|evol_p120d' \
    #              '|pnd_continue_pct_ud_alpha345_0_1|aadj_r_p60d_col_extre_0.2|evol_p30d|vol_p10d' \
    #              '|aadj_r_p10d_col_extre_0.2|MA_LINE_alpha_10_5_0_1'
    # info_str = 'market_top_300to800plus|20|True'

    # True True 0.021578 2.0663 3.5889 4.4756 55.44 3.7 5.01 3.1403 3.85
    # factor_str = 'wgt_return_p20d_0.2|evol_p30d|volume_count_down_p10d|aadj_r_p60d_col_extre_0.2' \
    #              '|pnd_continue_pct_ud_alpha345_0_1|MACD_20_60_18|aadj_r_p345d_continue_ud|volume_count_down_p120d' \
    #              '|CCI_p20d_limit_12|MA_LINE_alpha_10_5_0_1|aadj_r_p10d_col_extre_0.2'
    # info_str = 'market_top_300to800plus_industry_20_25_30_35|20|True'

    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSTECHNM00'
...
my_factor_dict = dict({
    ...
    'RSI_10_10': 'load_tech_factor',
    'RSI_10_30': 'load_tech_factor',
    'RSI_20_10': 'load_tech_factor',
    'RSI_20_30': 'load_tech_factor',
