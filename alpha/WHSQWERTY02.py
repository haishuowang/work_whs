...
def main_fun():
    ...
    exe_str = 'R_AssetDepSales_QTTM|pnd_count_down|60_1.0@add_fun@' \
              'R_SalesGrossMGN_First|col_zscore|120_1.0@add_fun@' \
              'R_NetInc_s_First|pnd_count_down|120_-1.0@add_fun@' \
              'PS_TTM|col_zscore|5_-1.0@add_fun@R_WorkCapital_QTTM|row_zscore_1.0@add_fun@' \
              'bulletin_num_df_20|pnd_count_down|60_1.0@add_fun@' \
              'R_CurrentAssetsTurnover_QTTM|pnd_vol|60_-1.0@add_fun@' \
              'R_OperProfit_s_POP_First|pnd_count_down|60_1.0@add_fun@' \
              'aadj_p_HIGH|col_zscore|20_-1.0@add_fun@' \
              'R_OperProfit_sales_s_First|pnd_count_down|20_1.0@add_fun@' \
              'R_DebtAssets_QTTM|pnd_count_down|5_-1.0'
