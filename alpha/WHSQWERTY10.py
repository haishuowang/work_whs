...
def main_fun():
    str_1 = 'index_000300|20|False|0.2'
    exe_str = 'R_SUMASSET_First|col_zscore|120_1.0@add_fun@TURNRATE|pnd_vol|120_-1.0@add_fun@' \
              'RZMRE|pnd_vol|120_-1.0@add_fun@R_TotProfit_EBIT_First|col_zscore|120_1.0@add_fun@' \
              'bar_num_12_df|row_zscore_-1.0@add_fun@news_num_df_20|row_zscore_-1.0@add_fun@' \
              'R_SalesGrossMGN_s_First|col_zscore|120_1.0@add_fun@R_TotLiab_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'R_OperCost_sales_s_First|pnd_vol|120_-1.0@add_fun@R_TotRev_TTM_QTTM|row_zscore_1.0@add_fun@' \
              'R_TotProfit_EBIT_First|col_zscore|60_1.0'
