...
if __name__ == '__main__':
    ...
    exe_str = 'R_RevenueTotPS_s_First|row_zscore_1.0@add_fun@PEG_PARENTNETPROFIT_3Y|col_zscore|60_-1.0@add_fun@' \
              'R_FairValChgPnL_s_First|pnd_vol|60_1.0@add_fun@R_OperProfit_s_YOY_First|pnd_vol|60_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_5Y|pnd_vol|5_-1.0@add_fun@R_TotRev_TTM_QTTM|col_zscore|120_1.0@add_fun@' \
              'TURNRATE|pnd_vol|20_-1.0@add_fun@PEG_OPCF_5Y|pnd_vol|5_-1.0@add_fun@' \
              'R_SalesCost_s_First|pnd_vol|60_-1.0@add_fun@R_GSCF_sales_s_First|row_zscore_1.0@add_fun@' \
              'R_ROENetIncRecur_s_First|pnd_vol|60_1.0 '
