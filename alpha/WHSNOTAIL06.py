...
def main_fun():
    str_1 = 'market_top_300to800plus|10|False|0.2'
    exe_str = 'PS_TTM|col_zscore|120_-1.0@add_fun@R_NetROA1_First|col_zscore|120_1.0@add_fun@' \
              'R_ParentProfit_s_YOY_First|col_zscore|120_1.0@add_fun@stock_tab1_2|pnd_vol|60_-1.0@add_fun@' \
              'R_GSCF_sales_s_First|pnd_vol|120_-1.0@add_fun@R_OPCF_sales_s_First|row_zscore_1.0@add_fun@' \
              'R_WorkCapital_First|row_zscore_1.0@add_fun@R_NetROA_s_First|col_zscore|120_1.0@add_fun@' \
              'R_GSCF_TTM_QTTM|pnd_vol|120_1.0@add_fun@R_Tax_TotProfit_QTTM|row_zscore_-1.0@add_fun@' \
              'lsgg_num_df_5|pnd_vol|20_-1.0'
