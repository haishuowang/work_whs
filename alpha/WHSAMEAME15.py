...
if __name__ == '__main__':
    ...
    exe_str = 'R_NetAssets_s_YOY_First|col_zscore|120_1.0@add_fun@' \
              'R_OperProfit_s_YOY_First|col_zscore|120_1.0@add_fun@R_SalesGrossMGN_First|col_zscore|120_1.0@add_fun@' \
              'R_ASSETOTHER_First|pnd_vol|60_1.0@add_fun@stock_tab4_2|pnd_vol|120_-1.0@add_fun@' \
              'stock_tab2_7|pnd_vol|20_-1.0@add_fun@R_CostSales_s_First|pnd_vol|60_-1.0@add_fun@' \
              'RQMCL|pnd_vol|60_1.0@add_fun@stock_tab2_5|pnd_vol|20_1.0@add_fun@RQYE|pnd_vol|60_-1.0@add_fun@' \
              'R_SUMASSET_First|col_zscore|5_1.0'
    filter_i = 1
