...
if __name__ == '__main__':
    ...
    exe_str = 'R_TotAssets_NBY_First|col_zscore|120_1.0@add_fun@PEG_PARENTNETPROFIT_3Y|col_zscore|60_-1.0@add_fun@' \
              'PEG_OPERATEREVE_3Y|pnd_vol|120_-1.0@add_fun@PEG_PARENTNETPROFIT_3Y|pnd_vol|60_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_5Y|pnd_vol|60_-1.0@add_fun@PEG_EBIT_3Y|row_zscore_-1.0@add_fun@' \
              'R_TotRev_TTM_Y3YGR|col_zscore|120_1.0@add_fun@R_TotRev_TTM_QSD4Y|pnd_vol|5_1.0@add_fun@' \
              'TVALCNY|pnd_vol|120_-1.0@add_fun@R_TotCapital_First|pnd_vol|20_1.0@add_fun@PEG_OPCF_3Y|row_zscore_-1.0'
