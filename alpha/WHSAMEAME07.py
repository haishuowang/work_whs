...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_EBIT_5Y|col_zscore|60_-1.0@add_fun@R_NetROA_TTM_First|pnd_vol|120_-1.0@add_fun@' \
              'PEG_EBIT_3Y|row_zscore_-1.0@add_fun@R_TangAssets_TotLiab_QTTM|pnd_vol|120_-1.0@add_fun@' \
              'R_SUMASSET_First|col_zscore|120_1.0@add_fun@stock_tab4_1|pnd_vol|120_-1.0@add_fun@' \
              'aadj_p_OPEN|pnd_vol|60_-1.0@add_fun@R_SUMLIAB_Y3YGR|col_zscore|120_1.0@add_fun@' \
              'funds|pnd_vol|60_-1.0@add_fun@R_TotAssets_NBY_First|col_zscore|120_1.0@add_fun@' \
              'lsgg_num_df_20|pnd_vol|20_-1.0'
