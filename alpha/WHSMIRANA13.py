...
def config_test():
    factor_str = 'OPCF_and_mcap_QYOY_Y3YGR_0.3|evol_p60d|R_SUMLIAB_QYOY_and_QTTM_0.3|RZYE_p60d_col_extre_0.2' \
                 '|PS_TTM_p10d_col_extre_0.2|aadj_r_p345d_continue_ud|REMFF.30|R_Revenue_s_YOY_First|evol_p20d' \
                 '|RZMRE_p345d_continue_ud|bias_turn_p60d'
    info_str = 'market_top_300to800plus|20|True'
    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA13'
