...
if __name__ == '__main__':
    str_1 = 'market_top_300plus_industry_20_25_30_35|5|True|0.1'
    exe_str = 'R_NetIncRecur_s_First|row_zscore_1.0@add_fun@PEG_PARENTNETPROFIT_3Y|pnd_vol|60_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_3Y|pnd_vol|20_-1.0@add_fun@bulletin_num_df_60|row_zscore_-1.0@add_fun@' \
              'PEG_EBIT_3Y|col_zscore|5_-1.0@add_fun@bar_num_7_df|row_zscore_-1.0@add_fun@' \
              'R_ROE_s_First|col_zscore|60_1.0@add_fun@R_OperProfit_sales_Y3YGR|row_zscore_-1.0@add_fun@' \
              'R_Cashflow_s_YOY_First|row_zscore_1.0'
