...
if __name__ == '__main__':
    ...
    exe_str = 'R_OperProfit_s_YOY_First|col_zscore|120_1.0@add_fun@R_NetROA_TTM_First|pnd_vol|60_-1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_3Y|col_zscore|20_-1.0@add_fun@news_num_df_20|col_zscore|60_-1.0@add_fun@' \
              'RZYE|col_zscore|60_-1.0@add_fun@stock_tab1_2|pnd_vol|120_1.0@add_fun@' \
              'PEG_PARENTNETPROFIT_3Y|pnd_vol|120_-1.0@add_fun@bar_num_7_df|pnd_vol|5_-1.0@add_fun@' \
              'meeting_decide|col_zscore|60_-1.0@add_fun@R_RevenuePS_s_First|pnd_vol|60_1.0@add_fun@' \
              'R_NetAssets_s_YOY_First|row_zscore_-1.0'
    filter_i = 1
