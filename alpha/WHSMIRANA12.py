...
def config_test():
    ...
    factor_str = 'R_OTHERLASSET_QYOY|REMTK.30|ab_sale_mng_exp|RZYE_p20d_col_extre_0.2|vol_p90d|REMTK.13' \
                 '|evol_p20d|aadj_r_p60d_col_extre_0.2|R_AssetDepSales_s_First|bias_turn_p60d'
    info_str = 'market_top_300to800plus|20|True'


    factor_name_list = factor_str.split('|')
    alpha_name = 'WHSMIRANA12'
