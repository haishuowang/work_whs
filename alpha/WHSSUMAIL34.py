...
if __name__ == '__main__':
    ...
    exe_str = 'R_EPS_s_First|row_zscore_1.0@add_fun@PEG_PARENTNETPROFIT_5Y|col_zscore|120_-1.0@add_fun@' \
              'R_Revenue_s_POP_First|col_zscore|20_-1.0@add_fun@R_EPS_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'lsgg_num_df_20|row_zscore_-1.0@add_fun@R_TotRev_TTM_QSD4Y|col_zscore|120_1.0@add_fun@' \
              'aadj_p_HIGH|row_zscore_-1.0@add_fun@R_OPCF_TotDebt_QTTM|pnd_vol|60_1.0@add_fun@' \
              'R_NetWorkCapital_QTTM|col_zscore|20_-1.0@add_fun@aadj_p|col_zscore|5_-1.0@add_fun@' \
              'aadj_p|pnd_vol|120_-1.0 '
