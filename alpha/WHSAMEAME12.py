...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_EBIT_3Y|row_zscore_-1.0@add_fun@R_SalesGrossMGN_First|col_zscore|60_1.0@add_fun@' \
              'PEG_OPERATEREVE_5Y|col_zscore|60_-1.0@add_fun@PEG_PARENTNETPROFIT_5Y|row_zscore_-1.0@add_fun@' \
              'R_TotAssets_s_YOY_First|col_zscore|120_1.0@add_fun@PEG_OPERATEREVE_5Y|pnd_vol|120_-1.0@add_fun@' \
              'news_num_df_20|col_zscore|120_-1.0@add_fun@R_NetAssets_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'TVALCNY|pnd_vol|120_-1.0@add_fun@TVALCNY|row_zscore_-1.0@add_fun@R_IntDebt_First|pnd_vol|120_1.0'
    filter_i = 1
