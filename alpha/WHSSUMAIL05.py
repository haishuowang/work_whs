...
if __name__ == '__main__':
    ...
    exe_str = 'R_ROETrig_First|row_zscore_1.0@add_fun@TVALCNY|row_zscore_-1.0@add_fun@' \
              'PEG_EBIT_3Y|col_zscore|60_-1.0@add_fun@R_ParentProfit_s_YOY_First|col_zscore|60_1.0@add_fun@' \
              'lsgg_num_df_5|pnd_vol|5_-1.0@add_fun@R_TotRev_TTM_QTTM|col_zscore|20_1.0@add_fun@' \
              'R_SUMASSET_First|col_zscore|20_1.0@add_fun@ab_rec|pnd_vol|120_1.0@add_fun@' \
              'bulletin_num_df_5|col_zscore|60_-1.0@add_fun@R_NetProfit_sales_s_First|pnd_vol|5_1.0@add_fun@' \
              'R_OPCF_NetInc_s_First|pnd_vol|5_1.0'
