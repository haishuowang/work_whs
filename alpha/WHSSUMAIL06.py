...
if __name__ == '__main__':
    str_1 = 'market_top_300plus|30|True|0.2'
    exe_str = 'stock_tab2_9|row_zscore_1.0@add_fun@PEG_PARENTNETPROFIT_5Y|pnd_vol|5_-1.0@add_fun@' \
              'PEG_EBIT_5Y|pnd_vol|60_-1.0@add_fun@R_NetInc_s_First|pnd_vol|60_1.0@add_fun@' \
              'PEG_EBIT_3Y|pnd_vol|120_-1.0@add_fun@stock_tab2_7|pnd_vol|20_-1.0@add_fun@' \
              'R_CFO_TotRev_s_First|pnd_vol|5_-1.0@add_fun@R_Tax_TotProfit_QTTM|pnd_vol|60_-1.0@add_fun@' \
              'R_RecurNetProft_NetProfit_s_First|pnd_vol|20_-1.0'
