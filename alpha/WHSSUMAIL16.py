...
if __name__ == '__main__':
    str_1 = 'market_top_300to800plus|10|True|0.1'
    exe_str = 'R_NetROA_s_First|row_zscore_1.0@add_fun@PEG_OPERATEREVE_5Y|row_zscore_-1.0@add_fun@' \
              'PEG_OPERATEREVE_3Y|col_zscore|120_-1.0@add_fun@lsgg_num_df_5|pnd_vol|5_-1.0@add_fun@' \
              'PE_TTM|pnd_vol|20_-1.0@add_fun@R_NetWorkCapital_QTTM|col_zscore|5_-1.0@add_fun@' \
              'R_SUMASSET_First|pnd_vol|60_1.0@add_fun@R_Revenue_s_POP_First|pnd_vol|120_-1.0@add_fun@' \
              'R_NetInc_s_First|col_zscore|60_1.0@add_fun@R_OPCF_TotDebt_QTTM|pnd_vol|60_1.0@add_fun@' \
              'R_CostSales_s_First|pnd_vol|5_1.0'
