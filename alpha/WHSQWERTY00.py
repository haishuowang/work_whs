...
if __name__ == '__main__':
    str_1 = 'market_top_300plus_industry_20_25_30_35|20|False|0.2'
    exe_str = 'R_AssetDepSales_QTTM|pnd_count_down|60_1.0@add_fun@stock_tab2_7|pnd_count_down|5_1.0@add_fun@RZYE|pnd_count_down|5_1.0@add_fun@bar_num_12_df|row_zscore_-1.0@add_fun@bar_num_12_df|pnd_count_down|5_1.0@add_fun@PE_TTM|col_zscore|5_-1.0@add_fun@R_NetInc_s_First|col_zscore|60_1.0@add_fun@bulletin_num_df_60|pnd_count_down|20_1.0@add_fun@R_DebtAssets_QTTM|pnd_count_down|20_1.0@add_fun@aadj_p_LOW|pnd_count_down|60_1.0@add_fun@R_TotLiab_s_YOY_First|row_zscore_1.0'
