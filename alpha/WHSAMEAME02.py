...
if __name__ == '__main__':
    ...
    exe_str = 'PEG_PARENTNETPROFIT_5Y|col_zscore|5_-1.0@add_fun@RZMRE|pnd_vol|20_-1.0@add_fun@' \
              'PEG_EBIT_5Y|col_zscore|60_-1.0@add_fun@RZYE|col_zscore|20_-1.0@add_fun@' \
              'PEG_EBIT_3Y|row_zscore_-1.0@add_fun@R_SalesGrossMGN_First|col_zscore|120_1.0@add_fun@' \
              'news_num_df_20|pnd_vol|20_-1.0@add_fun@ab_others_rec|pnd_vol|20_-1.0@add_fun@' \
              'R_ROETrig_First|col_zscore|120_1.0@add_fun@R_NetAssets_s_YOY_First|pnd_vol|20_-1.0@add_fun@' \
              'R_NetCashflowPS_s_First|col_zscore|120_1.0'
    filter_i = 0
