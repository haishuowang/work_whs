...
if __name__ == '__main__':
    ...
    exe_str = 'TURNRATE|pnd_vol|120_-1.0@add_fun@R_ROETrig_First|row_zscore_1.0@add_fun@' \
              'ab_sale_mng_exp|pnd_vol|5_-1.0@add_fun@stock_tab2_7|pnd_vol|20_-1.0@add_fun@' \
              'R_EPS_s_First|col_zscore|60_1.0@add_fun@R_WorkCapital_QTTM|col_zscore|5_-1.0@add_fun@' \
              'R_GSCF_TTM_QTTM|col_zscore|5_1.0@add_fun@PEG_PARENTNETPROFIT_5Y|col_zscore|60_-1.0@add_fun@' \
              'stock_tab2_9|row_zscore_1.0@add_fun@R_OperProfit_sales_Y3YGR|pnd_vol|60_-1.0@add_fun@' \
              'R_ROEWRecur_First|pnd_vol|120_1.0'
