...
def part_main_fun(if_only_long, hold_time, sector_name, percent):
    ...
    for i, mask_df in enumerate(mask_df_list):
        result_save_path = f'/mnt/mfs/dat_whs/result_new/beta_filter_only_long/{i}'
        factor_test.sector_df = raw_sector_df * mask_df.reindex(index=factor_test.xinx, columns=factor_test.xnms)
