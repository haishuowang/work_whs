...
class KeyFun:
    ...
    @staticmethod
    def load_notice_data(file_name, xinx, xnms, sector_df):
    ...
    def create_mix_factor(self, name_1, name_2, xinx, xnms, sector_df, if_only_long, percent):
        ...
        factor_2 = self.load_notice_data(name_2, xinx, xnms, sector_df)
...
def main_fun(time_para_dict, sector_name, hold_time, if_only_long):
    ...
    pool_num = 20
    main_model.main_test_fun(filter_list, ratio_list, notice_list, pool_num=pool_num, suffix_name='2', old_file_name='')
